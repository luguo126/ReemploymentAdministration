...
<script type="text/javascript">  
    $(function(){  
        ...
        $(":input[name='id']").change(function(){  
            ...
            val=$.trim(val);  
            if(val!=""){  
                var url="${pageContext.request.contextPath}/FindCompanyIdServlet";  
...
<body>
	...
	<form id="signupForm" class="form-horizontal" style="padding: 30px 100px 10px;"
		...
		<fieldset>
			<legend>公司注册账号</legend>
		</fieldset>

		<div class="form-group">

			<label for="account" class="col-sm-2 control-label">公司id：</label>
			<div class="col-sm-3">
				<input type="text" class="form-control " id="user_id"
					 name="id" placeholder="请输入id" autofocus="autofocus"/>
